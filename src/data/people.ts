...
export const people: Person[] = [
  ...
  },
  {
    ...
    familyRole: "Maternal uncle",
    relationshipToArnav: "Maternal uncle (mother's brother)",
    currentLocation: "Mason, Ohio, USA",
    parents: { father: "ramesh-chandra-agarwal", mother: "prem-kumari" },
  ...
  },
  {
    ...
    name: "Anayra Agarwal",
    sex: "F",
    birth: { place: "Foster City, California, USA" },
    isLiving: true,
    generation: 4,
    familyRole: "Maternal first cousin",
    parents: { father: "vivek-agarwal", mother: "rashi-agarwal" },
    publicity: "summary",
    bio: "Daughter of Vivek and Rashi Agarwal. Born in Foster City, California.",
  },
  {
    ...
    parents: { father: "vivek-agarwal", mother: "rashi-agarwal" },
    publicity: "summary",
    bio: "Son of Vivek and Rashi Agarwal. Born in Foster City, California.",
  },
  {
    slug: "nayonika-agarwal",
    name: "Nayonika Agarwal",
    sex: "F",
    birth: { place: "Mason, Ohio, USA" },
    isLiving: true,
    generation: 4,
    familyRole: "Maternal first cousin",
    parents: { father: "nitin-agarwal", mother: "manjari-garg" },
    publicity: "summary",
    bio: "Daughter of Nitin and Manjari Agarwal. Born in Mason, Ohio.",
  },
  {
    slug: "rayaan-agarwal",
    name: "Rayaan Agarwal",
    ...
    parents: { father: "nitin-agarwal", mother: "manjari-garg" },
    publicity: "summary",
    bio: "Son of Nitin and Manjari Agarwal. Born in Mason, Ohio.",
  },
  {
    ...
    publicity: "summary",
    bio: "Atharva Agarwal, known in the family as Yotak, is the son of Kapil and Nidhi Agarwal. Born in Jhansi.",
  },
  {
